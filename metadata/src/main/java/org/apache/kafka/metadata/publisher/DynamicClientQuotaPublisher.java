...
import org.apache.kafka.server.metadata.ClientQuotaMetadataManager;
...
public class DynamicClientQuotaPublisher implements MetadataPublisher {
    ...
    public DynamicClientQuotaPublisher(int nodeId, FaultHandler faultHandler, String nodeType, ClientQuotaMetadataManager clientQuotaMetadataManager) {
        this.nodeId = nodeId;
    ...
    public void onMetadataUpdate(MetadataDelta delta, MetadataImage newImage, LoaderManifest manifest) {
        try {
            ...
            faultHandler.handleFault("Uncaught exception while publishing dynamic client quota changes from MetadataDelta up to "
